...
class DashboardsControllerTest < ActionController::TestCase
  ...
  test "should create dashboard" do
    assert_difference('Dashboard.count') do
      post :create, dashboard: { cells: @dashboard.cells, css: @dashboard.css, enabled: @dashboard.enabled, name: @dashboard.name, refresh: @dashboard.refresh, slug: @dashboard.slug }
    end
  ...
  test "should update dashboard" do
    patch :update, id: @dashboard, dashboard: { cells: @dashboard.cells, css: @dashboard.css, enabled: @dashboard.enabled, name: @dashboard.name, refresh: @dashboard.refresh, slug: @dashboard.slug }
    assert_redirected_to dashboard_path(assigns(:dashboard))
  end
